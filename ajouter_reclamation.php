		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form  action="controller/AjouterReclamation.php?id=<?php echo $_SESSION['id_ens']?>" method="post" >
						
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Num Salle</label>
							<div class="col-sm-12 col-md-10">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<select class="custom-select col-12" name="type">
									...
									<option value="Salle de TP">Salle de TP</option>
								</select>
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Périoritée</label>
							<div class="col-sm-12 col-md-10">
