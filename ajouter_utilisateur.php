		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-video-player-1"></span><span class="mtext">Utilisateur</span>
						</a>
						<ul class="submenu">
							<li><a href="ajouter_utilisateur.php">Ajouter</a></li>
							<li><a href="liste_utilisateur.php">Consulter</a></li>
						</ul>
					</li>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form  action="controller/ajouterUtilisateur.php" method="POST" >
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Statu</label>
							<div class="col-sm-12 col-md-10">
								<select class="custom-select col-12" name="statu">
