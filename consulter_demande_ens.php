...
session_start();
$idd = $_SESSION['id_ens'];
$res = $bdd->query("select * from reservation where id_ens = $idd");
?>
<!DOCTYPE html>
<html>
									...
									<tr>
										...
										<td>
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" href="controller/supprReservation_ens.php?id=<?php  echo $ligne['id_reservation'] ?>"><i class="dw dw-delete-3"></i> Supprimer</a>
											</div>
										</div>
										</td>
									</tr>
