...
$res = $bdd->query("select * from videoprojecteur");
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Liste Projecteur</li>
								</ol>
							</nav>
						</div>
						...
						<table class="data-table table stripe hover nowrap">
							<thead>
								<tr>
									...
									<th class="datatable-nosort">Modèle</th>
							...
							<tbody>
								...
								<tr>
									<td class="table-plus"><?php echo $ligne['id_vp']; ?></td>
									<td><?php echo $ligne['modele']; ?></td>
									<td><?php if($ligne['etat'] == 0)
																			echo "<span class='badge badge-success'>Libre</span>";
																			else
																			echo "<span class='badge badge-danger'>Reservé</span>"; 
									?></td>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="modifier_projecteur.php?id=<?php echo $ligne['id_vp']?>"><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item" href="controller/supprProjecteur.php?id=<?php echo $ligne['id_vp'];?>"><i class="dw dw-delete-3"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
