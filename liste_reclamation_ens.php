...
session_start();
$idd = $_SESSION['id_ens'];
$res = $bdd->query("select * from reclamation where id_ens = $idd");
?>
<!DOCTYPE html>
<html>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="liste_reclamation_ens.php" class="dropdown-toggle no-arrow">
								...
								<?php while ($ligne = $res->fetch()) {?>
									<tr>
										...
										<td>
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="controller/supprReclamation_ens.php?id=<?php  echo $ligne['id_reclamation'] ?>"><i class="dw dw-delete-3"></i> Supprimer</a>
											</div>
										</div>
										</td>
									</tr>
